  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 px-4">
      <div className="bg-white/95 p-6 rounded-2xl shadow-lg w-full max-w-md border border-slate-200">
        ...
        {errMsg && (
          <div className={`p-2 rounded mb-3 text-xs text-center ${
            ...
            <form onSubmit={handleLogin} autoComplete="on">
              <div className="mb-3">
                ...
                <input
                  ...
                  className="mt-1 w-full px-3 py-1.5 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#5faeb6] bg-white shadow text-sm"
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    className="mt-1 w-full px-3 py-1.5 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#5faeb6] bg-white shadow pr-10 text-sm"
                  ...
                  >
                    {showPwd ? (
                      <svg viewBox="0 0 20 20" fill="none" className="w-4 h-4"><path d="M1.458 10C2.732 5.943 6.522 3 10 3c3.478 0 7.268 2.943 8.542 7-1.274 4.057-5.064 7-8.542 7-3.478 0-7.268-2.943-8.542-7z" stroke="#64748b" strokeWidth="1.5"/><circle cx="10" cy="10" r="3" stroke="#64748b" strokeWidth="1.5"/></svg>
                    ) : (
                      <svg viewBox="0 0 20 20" fill="none" className="w-4 h-4"><path d="M3 3l14 14M17.5 10c-.4 1.2-1.1 2.4-2.1 3.4C13.2 15.2 11.7 16 10 16c-1.7 0-3.2-.8-5.4-2.6C3.6 12.4 2.9 11.2 2.5 10c.4-1.2 1.1-2.4 2.1-3.4C6.8 4.8 8.3 4 10 4c1.7 0 3.2.8 5.4 2.6 1 .9 1.7 2.1 2.1 3.4z" stroke="#64748b" strokeWidth="1.5"/><path d="M7.5 7.5a3 3 0 004 4" stroke="#64748b" strokeWidth="1.5"/></svg>
                    )}
                  </button>
                </div>
              </div>
              ...
              <div className="mb-4 flex justify-end">
                <button
                  ...
                  className="text-xs text-[#5faeb6] hover:underline"
                >
                  Forgot password?
                </button>
              </div>
          ...
          <div className="forgot-password-form">
            {resetStep === 1 && (
              <form onSubmit={handleForgotPassword} autoComplete="on">
                <h3 className="text-lg font-semibold text-slate-800 mb-3">Reset Password</h3>
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="mt-1 w-full px-3 py-1.5 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white shadow text-sm"
                    placeholder="Enter your email"
                    required
                    autoComplete="username"
                  />
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bg-gray-200 text-slate-800 py-1.5 rounded-xl hover:bg-gray-300 transition font-medium text-sm"
                  >
                    Back to Login
                  </button>
                  <button
                    type="submit"
                    className="flex-1 bg-[#5faeb6] text-[#f6f7f9] py-1.5 rounded-xl shadow hover:bg-[#3f6184] transition font-semibold disabled:opacity-60 text-sm"
                    disabled={loading}
                  >
            ...
            {resetStep === 2 && (
              <form onSubmit={handleVerifyCode} autoComplete="on">
                <h3 className="text-lg font-semibold text-slate-800 mb-3">Enter Verification Code</h3>
                <p className="text-xs text-slate-600 mb-3">
                  We sent a 6-digit code to {resetEmail}
                </p>
                <div className="mb-3">
                  <label htmlFor="reset-code" className="block text-xs font-medium text-slate-700">
                    Verification Code
                  </label>
                  <input
                    id="reset-code"
            ...
            {resetStep === 3 && (
              <form onSubmit={handleResetPassword} autoComplete="on">
                <h3 className="text-lg font-semibold text-slate-800 mb-3">Set New Password</h3>
                <div className="mb-3">
                  <label htmlFor="reset-new-password" className="block text-xs font-medium text-slate-700">
                    New Password
                  </label>
                  <input
